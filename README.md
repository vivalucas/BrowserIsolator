...
- **设置面板**：查看 Chrome 状态和版本、打开数据目录、复制路径、重新下载 Chrome、切换语言、外观模式、高级详情显示，以及帮助与更新信息
...
- **设置**：点击工具栏齿轮，查看 Chrome 状态、打开数据目录、复制路径、重新下载 Chrome、切换语言和外观模式，或在“帮助与更新”中检查更新、打开 Releases 页面和查看联系方式
