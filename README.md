...
- **设置面板**：查看 Chrome 状态和版本、打开数据目录、复制路径、重新下载 Chrome、切换语言、外观模式、高级详情显示，以及版本更新、作者和反馈入口
...
后续应用版本更新可以在应用内进入 **设置 -> 帮助与更新 -> 检查更新**。BrowserIsolator 使用 Sparkle 从 GitHub Releases 获取更新；首次安装仍需要从 Releases 下载 DMG。
...
- **设置**：点击工具栏齿轮，查看 Chrome 状态、打开数据目录、复制路径、重新下载 Chrome、切换语言和外观模式，或在“帮助与更新”中检查更新、前往发布页、查看作者联系方式和提交反馈
...
支持应用内检查更新。点击菜单栏“检查更新”，或进入 **设置 -> 帮助与更新 -> 检查更新**，应用会通过 Sparkle 检查 GitHub Releases 上的新版本。当前暂不提供 Homebrew 安装源，避免同一个安装实例被多个更新来源同时管理。
