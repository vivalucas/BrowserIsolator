...
- **Informations d'environnement** : état, dossier, mode d'exécution, espace disque et dernière utilisation ; le port de débogage apparaît seulement au besoin dans les détails avancés
